...
const controlTime = () => {
    ...
    if (!timerOn) {
        ...
        localStorage.clear();
        localStorage.setItem("interval-id", interval)//we want to update it every 30 miliseconds
    }
...
return (
    <div className="center-align">
        ...
        <div className="timer">
            ...
            <button className="btn-small #546e7a blue-grey darken-1"
                onClick={controlTime}>
                {timerOn ? (
